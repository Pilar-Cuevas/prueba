...
describe('Accedo al blog: ', function() {
    it('Busco algun blog de Russo', function() {
        cy.visit('https://www.paradigmadigital.com/dev/enhanced-ecommerce-google/');
        cy.get('p.post-author',{ timeout: 2000 })
            .children('a.author')
            .should('contain', 'Marco Russo');
        ...
        cy.get('article.post_search_list',{ timeout: 5000 })
            .children('h2')
            .children('a')
            .should('contain','Impulsa tu tienda online con el Enhanced Ecommerce de Google');
        cy.get('article.post_search_list',{ timeout: 5000 })
            .children('h2')
            .children('a')
            .should('have.attr', 'title')
            .and('include', 'Impulsa tu tienda online con el Enhanced Ecommerce de Google');
    })
})
